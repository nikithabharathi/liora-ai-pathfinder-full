        ...
        <div className="space-y-4">
          {messages.map(msg => (
            ...
            >
              ...
              <Card className={`max-w-md ${msg.isUser ? "bg-gradient-primary text-white" : "bg-gradient-card"}`}>
          ...
          <div className="flex items-end gap-2 bg-gradient-card rounded-2xl p-3 card-float">
            ...
            <div className="flex-1 relative">
              <Textarea
                ...
                className="resize-none border-0 bg-transparent focus-visible:ring-0 placeholder:text-muted-foreground/70 min-h-[40px] max-h-32"
                disabled={isTyping}
                rows={1}
              />
            </div>
            ...
            <Button type="submit" size="icon" className="shrink-0 bg-gradient-primary hover:opacity-90" disabled={!message.trim() || isTyping}>
              <Send size={20} />
            </Button>
          </div>
        </form>
